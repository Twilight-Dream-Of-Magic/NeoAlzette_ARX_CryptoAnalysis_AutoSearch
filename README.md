...
- `include/auto_search_frame/detail/` + `src/auto_search_frame/`
  - resumable best-search / hull-search implementation
...
- If you want the **PNB tools**, go to [pnb_distinguisher/README.md](pnb_distinguisher/README.md).
...
root research programs (best-trail search / tracing), while PNB tools now live
only in `pnb_distinguisher/`.
