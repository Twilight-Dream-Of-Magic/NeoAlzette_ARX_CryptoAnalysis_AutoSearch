...
static std::pair<std::uint32_t, int> choose_subtraction_by_constant_output_difference_and_weight_greedily(
    ...
    const std::uint32_t greedy_output_difference =
        compute_greedy_output_difference_for_addition_by_constant(input_difference, additive_constant);
...
static void trace_differential_trail_path(std::uint32_t initial_branch_a_difference, std::uint32_t initial_branch_b_difference) {
    ...
    // A -= ROUND_CONSTANTS[1]
    {
        const auto [output_branch_a_difference_after_constant_subtraction, constant_subtraction_weight] =
            choose_subtraction_by_constant_output_difference_and_weight_greedily(branch_a_difference, NeoAlzetteCore::ROUND_CONSTANTS[1]);
    ...
    // B -= ROUND_CONSTANTS[6]
    {
        const auto [output_branch_b_difference_after_constant_subtraction, constant_subtraction_weight] =
            choose_subtraction_by_constant_output_difference_and_weight_greedily(branch_b_difference, NeoAlzetteCore::ROUND_CONSTANTS[6]);
    ...
    std::cout << "\nFinal Estimated Probability: 2^" << std::log2(total_probability) << "\n";
}
