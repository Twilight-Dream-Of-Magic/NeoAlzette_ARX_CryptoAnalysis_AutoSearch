...
**Status:** engineering master draft aligned with the current paper and `linear_correlation_addconst_flat.hpp`  
...
- `linear_correlation_addconst_flat.hpp` for the executable specification.
...
## 7. Implementation architecture (`linear_correlation_addconst_flat.hpp`)
...
- the executable specification in `linear_correlation_addconst_flat.hpp`.
